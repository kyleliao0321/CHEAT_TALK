...
class ChatHistoryItemHelper(
    dragDir: Int,
    swipeDir: Int,
    private val listener: ChatHistoryEventListener
    ...
    override fun onSelectedChanged(viewHolder: RecyclerView.ViewHolder?, actionState: Int) {
        if (viewHolder != null) {
            val foregroundView: View = (viewHolder as ChatHistoriesAdapter.ViewHolder).foregroundView
